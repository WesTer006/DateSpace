    ...
    public class RecommendationRepository : IRecommendationRepository
    {
        ...
        public async Task<List<AppUser>> GetRecommendationsAsync(string userId, Preference? preference, int page, int pageSize)
        {
            ...
            var query = _context.Users
                ...
                .Where(u => u.Id != userId)
                .Where(u =>
                    !_context.Swipes.Any(s => s.SwiperId == userId && s.TargetId == u.Id) && // ты ещё не свайпал
                    !_context.Swipes.Any(s => s.SwiperId == u.Id && s.TargetId == userId && s.TargetAgree == true) // match
                );
